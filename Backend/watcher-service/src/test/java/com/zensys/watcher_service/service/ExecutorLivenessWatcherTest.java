...
class ExecutorLivenessWatcherTest {
    ...
    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(livenessWatcher, "heartbeatTimeoutSeconds", 30L);
    ...
    void testScan_ExecutorDead_TriggersRetry() {
        ...
        ArgumentCaptor<JobRunLifecycleEvent> lifecycleCaptor = ArgumentCaptor.forClass(JobRunLifecycleEvent.class);
